...
A continuación se muestra una tabla representativa de los requisitos cumplidos, recalcando en cada caso con que herramienta o configuración se ha conseguido cumplir.
\begin{table}[H]
    \centering
    \scriptsize

...
interface GigabitEthernet1/0/6
 ...
 switchport trunk allowed vlan 2-189,191-1001
 switchport mode access
!
interface GigabitEthernet1/0/7
!
...
\subsection{Switch DHCP Interno}
A continuación se muestra la configuración completa del dispositivo de red Switch DHCP interno.
\begin{lstlisting}[language=Bash, caption={Configuración Completa Switch DHCP interno}]
!
version 16.3.2
no service timestamps log datetime msec
no service timestamps debug datetime msec
...
!
interface Vlan200
 mac-address 00d0.d34b.c101
 ip address 10.1.0.13 255.255.255.224
!
router ospf 10
 log-adjacency-changes
 network 10.1.0.0 0.0.0.31 area 0
...
\end{lstlisting}
\subsection{Switch DHCP IoMT}
A continuación se muestra la configuración completa del dispositivo de red Switch DHCP IoMT.
\begin{lstlisting}[language=Bash, caption={Configuración Completa Switch DHCP IoMT}]
!
version 16.3.2
no service timestamps log datetime msec
no service timestamps debug datetime msec
...
!
interface Vlan200
 mac-address 0001.9704.5101
 ip address 10.1.0.15 255.255.255.224
!
router ospf 10
 log-adjacency-changes
 network 10.1.0.0 0.0.0.31 area 0
...
!
ip nat inside source list 1 interface Serial0/0 overload
ip nat inside source static 10.0.3.7 195.136.17.22 
ip classless
!
ip flow-export version 9
!
